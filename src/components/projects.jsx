  ...
  return (
    ...
    <div className="portfolio-container">
      <div className="portfolio-column">
        ...
        <div className="project">
          <div class="image-container">
            <a href="https://www.figma.com/design/G389jkPP6MbCHy0YCvUiFG/VNT?node-id=0-1" target="_blank">
      ...
      <div className="portfolio-column">
        <div className="project">
        <div class="image-container">
        <a href="https://www.figma.com/design/b58rE33Gavzzfulf1znnpJ/Yoga-App?node-id=0-1" target="_blank">
            <img src={Grounded} />
            </a>
          </div>
          <div class="text-container">
        ...
        <div className="project">
             <div class="image-container">
              <a href="https://community-catalyst-z5za.onrender.com/" target="_blank">
